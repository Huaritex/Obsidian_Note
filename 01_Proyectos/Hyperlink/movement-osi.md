...
> [!info] Cuando tu aplicación (digamos, el cliente Tauri en tu Arch Linux) decide sincronizar una nota con la nube, los datos bajan desde la capa superior a la inferior.
...
|**Capa [[modelo-osi]]**|**Unidad de Datos (PDU)**|**Ejemplo de Protocolo**|
|---|---|---|
